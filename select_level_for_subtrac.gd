...
func _on_yes_for_easy_pressed() -> void:
	get_tree().change_scene_to_file("res://easy sub 1.tscn")
...
func _on_yes_for_medium_pressed() -> void:
	get_tree().change_scene_to_file("res://medium sub 1.tscn")
...
func _on_yes_for_hard_pressed() -> void:
	get_tree().change_scene_to_file("res://hard sub 1.tscn")
